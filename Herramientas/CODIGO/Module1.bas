...
On Local Error GoTo Errhandler
    ...
    Select Case file_type
        ...
        Case Midi
            SourceFilePath = resource_path & "\MIDI.cao"
            OutputFilePath = SOUNDS_PATH
        
        Case MP3
            SourceFilePath = resource_path & "\MP3.cao"
            OutputFilePath = MP3_PATH
...
Errhandler:
    ...
    MsgBox "No se logró extraer los archivos. Motivo: " & Err.Number & " : " & Err.Description, vbOKOnly, "Error"
End Function
    ...
    For loopc = 0 To UBound(InfoHead())
        ...
        Select Case LCase$(Right$(Trim$(InfoHead(loopc).strFileName), 3))
            ...
            Case Is = "mid"
                ...
                FileExtension = "mid"
                OutputFilePath = resource_path & "\MIDI.cao"
                mid_done = True
            Case Is = "mp3"
...
On Local Error GoTo Errhandler
    ...
    Select Case file_type
        ...
        Case Midi
            SourceFilePath = SOUNDS_PATH
            SourceFileExtension = ".mid"
            OutputFilePath = dest_path & "MIDI.cao"
        
        Case MP3
            SourceFilePath = MP3_PATH
        ...
        Case Scripts
            SourceFilePath = SCRIPT_PATH
            SourceFileExtension = ".*"
            OutputFilePath = dest_path & "Init.cao"
        
        Case Patch
            SourceFilePath = PATCH_PATH
            SourceFileExtension = ".*"
            OutputFilePath = dest_path & "Patch.cao"
    
        Case Interface
            SourceFilePath = INTERFACE_PATH
        ...
        Case Skins
            If LenB(strCurSkinName) = 0 Then Exit Function
            MsgBox strCurSkinName
            SourceFilePath = SKIN_PATH & strCurSkinName & "\"
            SourceFileExtension = ".jpg"
    ...
    If FileHead.intNumFiles = 0 Then
        MsgBox "No hay archivos con la extención " & SourceFileExtension & " en " & SourceFilePath & ".", , "Error"
        Exit Function
    End If
