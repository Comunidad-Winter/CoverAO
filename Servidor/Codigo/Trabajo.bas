...
Public Function ObjEsRobable(ByVal VictimaIndex As Integer, _
    ...
    ObjEsRobable = ObjData(OI).OBJType <> eOBJType.otLlaves And UserList(VictimaIndex).Invent.Object(slot).Equipped = _
            0 And ObjData(OI).Real = 0 And ObjData(OI).Caos = 0 And ObjData(OI).Milicia = 0 And ObjData(OI).Shop = 0 And ObjData(OI).OBJType <> eOBJType.otMonturas And ObjData(OI).OBJType <> eOBJType.otBarcos
