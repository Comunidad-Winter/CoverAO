...
Call CustomKeys.SaveCustomKeys
 If PrimeraVez = 1 Then
    ...
    End If
   AddtoRichTextBox frmMain.RecTxt, "Elegiste la configuración de controles moderna, recuerda que puedes cambiarlo en cualquier momento ingresando en el menú de opciones.", 65, 190, 156, False, False, True
...
Call CustomKeys.SaveCustomKeys
 If PrimeraVez = 1 Then
    ...
    Call WriteVar(App.Path & "\Init\CovAoInit.ini", "LAUNCHER", "PrimeraVez", PrimeraVez)
    End If
  AddtoRichTextBox frmMain.RecTxt, "Elegiste la configuración de controles clásicos, recuerda que puedes cambiarlo en cualquier momento ingresando en el menú de opciones.", 65, 190, 156, False, False, True
Unload Me
End Sub
