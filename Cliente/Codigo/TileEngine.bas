        ...
        If Nombres Then
            ...
            If Len(.Nombre) > 0 Then
                ...
                If .EsUsuario Then
                    ...
                    If Not .Invisible Or charindex = CurrentUser.UserCharIndex Then
...
errorhandler:
    ...
    MsgBox "¡No se ha logrado iniciar el engine gráfico! Reinstale los últimos controladores de DirectX desde www.coverao.com.ar (registrador de librerias) y actualize sus controladores de video. Si el problema persiste por favor consulte al soporte de CoverAO en sus redes sociales.", vbCritical, "Saliendo"
    Call CloseClient
End Sub
